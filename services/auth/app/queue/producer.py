...
class AuthEventProducer:
    ...
    def connect(self):
        ...
        while True:
            ...
            try:
                ...
                logger.info(
                    "Connecting auth producer to RabbitMQ..."
                )
                ...
                logger.info(
                    "Auth RabbitMQ producer connected successfully"
                )
    ...
    def reconnect(self):
        ...
        logger.warning(
            "Reconnecting auth RabbitMQ producer..."
        )
    ...
    def publish_auth_event(
        ...
        try:
            ...
            logger.error(
                "Failed to publish auth event: %s",
                str(error)
            )
    ...
    def close(self):
        ...
        try:
            ...
            logger.info(
                "Auth RabbitMQ producer connection closed"
            )
