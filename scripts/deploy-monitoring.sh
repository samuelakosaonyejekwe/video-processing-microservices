...
for manifest in prometheus-rbac.yaml prometheus-configmap.yaml prometheus-pvc.yaml prometheus.yaml kube-state-metrics.yaml node-exporter.yaml rabbitmq-metrics-service.yaml grafana-pvc.yaml grafana.yaml gateway-servicemonitor.yaml auth-servicemonitor.yaml converter-servicemonitor.yaml notification-servicemonitor.yaml; do
