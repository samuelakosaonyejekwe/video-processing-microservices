...
# Inter-service URLs
export JWT_AUTH_SERVICE_URL="${JWT_AUTH_SERVICE_URL:-http://auth-service.${K8S_NAMESPACE}.svc.cluster.local:8001}"
export CONVERTER_SERVICE_URL="${CONVERTER_SERVICE_URL:-http://converter-service.${K8S_NAMESPACE}.svc.cluster.local:8002}"
export NOTIFICATION_SERVICE_URL="${NOTIFICATION_SERVICE_URL:-http://notification-service.${K8S_NAMESPACE}.svc.cluster.local:8003}"
...
export AUTH_PORT="${AUTH_PORT:-8001}"
export AUTH_APP_PORT="${AUTH_APP_PORT:-8001}"
